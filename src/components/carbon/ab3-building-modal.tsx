...
import { ab3ProfileSpecs } from "@/lib/carbon-data";
...
const sections: ScrollNavSection[] = [
  { id: "section-measurement", label: "Stage 1: Measurement & Solar", shortLabel: "Measurement", badge: "98% Cov" },
  ...
  { id: "section-ask", label: "Stage 5: Grounded AI Assistant", shortLabel: "Ask Carbon", badge: "AI" },
];

export function AB3BuildingModal({ isOpen, onClose }: AB3BuildingModalProps) {
  ...
  useEffect(() => {
    ...
    // AB3 North Lab Wing (Step-down architecture)
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-300">
              MIT Manipal Campus · 13.35126° N, 74.79309° E · Centralised Chiller Plant
            </p>
          </div>
        </div>
        ...
        <div className="h-full grid grid-cols-1 lg:grid-cols-12">
          ...
          >
            <div className="max-w-4xl mx-auto">
              <BuildingDeepDive onJumpToSection={scrollToStage} />
            </div>
          </main>
        </div>
